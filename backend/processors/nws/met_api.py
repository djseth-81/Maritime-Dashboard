...
def nws_weather(station: dict):
    ...
    return {
        ...
        'src_id': station['id'],
        'timestamp': timestamp,  # Y-M-DTH:M:S
        'air_temperature': guh['temperature'],  # F
        'wind_speed': float(guh['windSpeed'].split()[index]),  # mph
        'wind_heading': heading,  # Deg from cardinal directions
        # converting probabilty to be < 1
        ...
        'humidity': None,  # Collected by CO-OP
        'forecast': None,  # Taking instantaneous forecast, do we even want this?
        'event_id': None,  # Is this even necessary?
        'visibility': None,  # Collected by CO-OP
    }
...
if __name__ == "__main__":
    ...
    for station in stations:
        weather_reports.append(nws_weather(station))
        # input()
